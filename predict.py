...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        # Flow matching schedulers don't use guidance_rescale — force to 0 to avoid artifacts.
        is_flow_match = scheduler.startswith("Flow Match")
        gen_kwargs = {
            "guidance_scale": cfg_scale, "guidance_rescale": 0 if is_flow_match else guidance_rescale,
